...
var _jacketOptionFlag='con giacca'; //衣服带夹克标识
...
var _optionTypeGuide={1:{"image":"/js/jquery/it/images/guide_weddingdress.png","flag":"waist","bigImage":"/js/jquery/it/images/68-large.png"},2:{"image":"/js/jquery/it/images/guide_jacket.png","flag":"shoulder","bigImage":"/js/jquery/it/images/guide-jacket-large.png"}};
...
function _cnstra(key){
  var lan =	{"bust":"Seno","waist":"Vita","hips":"Fianchi","hollow to floor":"Dalla fossetta del giugulo a terra","height":"Altezza","jacket":"Giacca","with jacket":"Con Giacca","without jacket":"Senza Giacca","shoulder (inch)":"Spalla(pollice)","armseye (inch)":"Giromanica(pollice)","arm length (inch)":"Dalla spalla al seno(pollice)","measurement unit":null,"custom size":"Taglia personalizzata","bust":"Seno","waist":"Vita","hips":"Fianchi","hollow to floor":"Dalla fossetta del giugulo a terra","inch":"pollice"};
