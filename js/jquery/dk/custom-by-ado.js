...
var _unitInch='inch';
var _unitCm='cm';
var _customSizeOptionFlag='kundetilpasset størrelse'; //自定义size标识
var _jacketOptionFlag='med jakke'; //衣服带夹克标识Mit Jacke

//翻译en
function _cnstra(key){
   var lan = {"bust":"Buste","waist":"Talje","hips":"Tofter","hollow to floor":"Hul til gulv","shoulder (inch)":"Skulder(inch)","armseye (inch)":"ærmegab(inch)","armhole (inch)":"ærmegab(inch)","arm length (inch)":"armlængde(inch)","height":"Højde"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
...
var _relatedOptionsSubmitLable='bestem';
var _relatedOptionsCancelLable='afbestille';
var _optionTypeGuide={1:{"image":"/js/jquery/dk/images/guide_weddingdress.png","flag":"waist","bigImage":"/js/jquery/dk/images/68-large.png"},2:{"image":"/js/jquery/dk/images/guide_jacket.png","flag":"shoulder","bigImage":"/js/jquery/dk/images/guide-jacket-large.png"}};
