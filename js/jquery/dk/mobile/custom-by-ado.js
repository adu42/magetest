...
function _cnstra(key){
   var lan = {"bust":"Buste","waist":"Talje","hips":"Hofter","hollow to floor":"Hule til gulv","shoulder (inch)":"Skulder (inch)","armseye (inch)":"ærmegab(inch)","armhole (inch)":"ærmegab(inch)","arm length (inch)":"Armlængde (inch)","height":"Højde"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
