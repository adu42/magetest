...
var _jacketOptionFlag='ohne jacke'; //衣服带夹克标识Mit Jacke

//翻译en
function _cnstra(key){
   var lan = {"bust":"Büste","waist":"Taille","hips":"Hüften","hollow to floor":"Schlüsselbeine zum Boden","shoulder (inch)":"Schulter(zoll)","armseye (inch)":"Armseye (zoll)","armhole (inch)":"Armloch (zoll)","arm length (inch)":"Armlänge(zoll)","height":"Höhe"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
