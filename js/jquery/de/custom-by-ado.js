...
var _unitInch='inch';
var _unitCm='cm';
var _customSizeOptionFlag='benutzerdefinierte größe'; //自定义size标识
var _jacketOptionFlag='mit jacke'; //衣服带夹克标识Mit Jacke

//翻译en
function _cnstra(key){
   var lan = {"bust":"Brust","waist":"Taille","hips":"Hüfte","hollow to floor":"Schlüsselbeine zum Boden","shoulder (inch)":"Schulterbreite (inch)","armseye (inch)":"Armseye (inch)","arm length (inch)":"Armlänge (inch)","height":"Höhe"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
...
var _optionTypeGuide={1:{"image":"/js/jquery/de/images/guide_weddingdress.png","flag":"waist","bigImage":"/js/jquery/de/images/68-large.png"},2:{"image":"/js/jquery/de/images/guide_jacket.png","flag":"shoulder","bigImage":"/js/jquery/de/images/guide-jacket-large.png"}};
