...
var _unitInch='tuuma';
var _unitCm='cm';
var _customSizeOptionFlag='räätälöity koko'; //自定义size标识
var _jacketOptionFlag='takki'; //衣服带夹克标识Mit Jacke

//翻译en
function _cnstra(key){
   var lan = {"bust":"Rintakuva","waist":"Vyötärö","hips":"Lonkat","hollow to floor":"Mitta kaulankuopasta lattiaan","shoulder (inch)":"Olkapää(tuumaa)","armseye (inch)":"Kädentie(tuumaa)","armhole (inch)":"Kädentie(tuumaa)","arm length (inch)":"Hartiasta rintaan(tuumaa)","height":"Pituus"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
...
var _optionTypeGuide={1:{"image":"/js/jquery/fi/images/guide_weddingdress.png","flag":"waist","bigImage":"/js/jquery/fi/images/68-large.png"},2:{"image":"/js/jquery/fi/images/guide_jacket.png","flag":"shoulder","bigImage":"/js/jquery/fi/images/guide-jacket-large.png"}};
