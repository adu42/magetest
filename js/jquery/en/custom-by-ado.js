...
function setJecketValueDefault(obj,val){
...
function setCustomSizeVals(obj,size,unit){
    ...
    var _obj=jQuery(obj).parents('div:eq(0)').nextAll('div.input-box-'+_sizeLable+'-guide,div.input-box-'+_jacketLable+'-guide');
    if(_obj.length>0){
