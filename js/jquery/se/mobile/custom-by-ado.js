...
var _jacketOptionFlag='med jacket'; //衣服带夹克标识med jacket

//翻译en
function _cnstra(key){
   var lan = {"bust":"Bröst","waist":"Midja","hips":"Höfter","hollow to floor":"Nyckelben till golvet","shoulder (inch)":"Skuldra (tum)","armseye (inch)":"Armseye (tum)","armhole (inch)":"ärmhål (tum)","arm length (inch)":"Arm Längd (tum)","height":"Höjd"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
