...
var _unitInch='tum';
var _unitCm='cm';
var _customSizeOptionFlag='personliga mått'; //自定义size标识
var _jacketOptionFlag='med jacket'; //衣服带夹克标识

//翻译en
function _cnstra(key){
   var lan = {"bust":"Bröst","waist":"Midja","hips":"Höfter","hollow to floor":"Nyckelben till golvet","shoulder (inch)":"Skuldra (tum)","armseye (inch)":"ärmhål (tum)","arm length (inch)":"Arm Längd (inch)","height":"Höjd"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
...
var _optionTypeGuide={1:{"image":"/js/jquery/se/images/guide_weddingdress.png","flag":"waist","bigImage":"/js/jquery/en/images/68-large.png"},2:{"image":"/js/jquery/se/images/guide_jacket.png","flag":"shoulder","bigImage":"/js/jquery/se/images/guide-jacket-large.png"}};
