...
var _unitInch='pouce';
var _unitCm='cm';
var _customSizeOptionFlag='mensurations personnalisées'; //自定义size标识
var _jacketOptionFlag='avec jacket'; //衣服带夹克标识Mit Jacke

//翻译en
function _cnstra(key){
   var lan = {"bust":"Tour de Poitrine","waist":"Tour de Taille","hips":"Hanches","hollow to floor":"Creux du cou - sol","shoulder (inch)":"Épaule (inch)","armseye (inch)":"Emmanchure(pouces)","arm length (inch)":"Longueur de bras (pouces)","height":"Hauteur"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
...
var _optionTypeGuide={1:{"image":"/js/jquery/fr/images/guide_weddingdress.png","flag":"waist","bigImage":"/js/jquery/fr/images/68-large.png"},2:{"image":"/js/jquery/fr/images/guide_jacket.png","flag":"shoulder","bigImage":"/js/jquery/fr/images/guide-jacket-large.png"}};
