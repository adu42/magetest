...
var _unitInch='inch';
var _unitCm='cm';
var _customSizeOptionFlag='aangepaste maat'; //自定义size标识
var _jacketOptionFlag='met jasje'; //衣服带夹克标识

//翻译en
function _cnstra(key){
   var lan = {"bust":"Buste","waist":"Taille","hips":"Heupen","hollow to floor":"Hol aan Floor","shoulder (inch)":"Schouder (inch)","armseye (inch)":"Armhole (inch)","arm length (inch)":"Arm Lengte (inch)","height":"Hoogte"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
...
var _optionTypeGuide={1:{"image":"/js/jquery/nl/images/guide_weddingdress.png","flag":"waist","bigImage":"/js/jquery/nl/images/68-large.png"},2:{"image":"/js/jquery/nl/images/guide_jacket.png","flag":"shoulder","bigImage":"/js/jquery/nl/images/guide-jacket-large.png"}};
