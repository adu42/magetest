...
var _jacketOptionFlag='met jasje'; //衣服带夹克标识Mit Jacke

//翻译en
function _cnstra(key){
   var lan = {"bust":"Buste","waist":"Taille","hips":"Heupen","hollow to floor":"Hol aan Floor","shoulder (inch)":"Schouder (inch)","armseye (inch)":"Armseye (inch)","armhole (inch)":"Armsgat (inch)","arm length (inch)":"Arm Lengte (inch)","height":"Hoogte"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
