...
var _jacketOptionFlag='con la chaqueta'; //衣服带夹克标识Mit Jacke

//翻译en
function _cnstra(key){
   var lan = {"bust":"Busto","waist":"Cintura","hips":"Caderas","hollow to floor":"Hueco para el piso","shoulder (inch)":"Hombro (pulgada)","armseye (inch)":"Sisa(pulgada)","armhole (inch)":"Sisa(pulgada)","arm length (inch)":"Longitud del brazo(pulgada)","height":"Altura"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
