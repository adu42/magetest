...
//标题标识,根据不同站翻译
var _unitInch='pulgada';
var _unitCm='cm';
var _customSizeOptionFlag='medida personalizada'; //自定义size标识
var _jacketOptionFlag='con la chaqueta'; //衣服带夹克标识

//翻译en
function _cnstra(key){
   var lan = {"bust":"Busto","waist":"Cintura","hips":"Caderas","hollow to floor":"Hueco(cuello) a suelo","shoulder (inch)":"Hombro(pulgada)","armseye (inch)":"Sisa(pulgada)","arm length (inch)":"Longitud del brazo(pulgadas)","height":"Altura"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
...
var _optionTypeGuide={1:{"image":"/js/jquery/es/images/guide_weddingdress.png","flag":"waist","bigImage":"/js/jquery/es/images/68-large.png"},2:{"image":"/js/jquery/es/images/guide_jacket.png","flag":"shoulder","bigImage":"/js/jquery/es/images/guide-jacket-large.png"}};
