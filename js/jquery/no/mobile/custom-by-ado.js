...
var _jacketOptionFlag='uten jacket'; //衣服带夹克标识Mit Jacke

//翻译en
function _cnstra(key){
   var lan = {"bust":"Bust","waist":"Midje","hips":"Hofter","hollow to floor":"Hode til gulv","shoulder (inch)":"Skulder (tommers)","armseye (inch)":"Armseye (tommers)","armhole (inch)":"Ermhull (tommers)","arm length (inch)":"Arm Lengde (tommers)","height":"Høyde"};
    key=key.toLowerCase();
	key=jQuery.trim(key);
