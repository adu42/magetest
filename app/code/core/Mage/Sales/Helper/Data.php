...
class Mage_Sales_Helper_Data extends Mage_Core_Helper_Data
{
	...
	/**
* edit by@ado 2013-4-11
*/
  public function getOrderItemThumbnail($productId){
	$read= Mage::getSingleton('core/resource')->getConnection('core_read');
	$sql="select a.`value` from catalog_product_entity_varchar a right join eav_attribute b on a.attribute_id=b.attribute_id where b.attribute_code='thumbnail' and a.entity_id='$productId' limit 1 ";
       $img= $read->fetchOne($sql);
      if($img)return Mage::getBaseurl('media').'catalog/product'.$img;
      return '';	
