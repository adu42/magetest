...
class Mage_Sales_Block_Order_Invoice extends Mage_Sales_Block_Order_Invoice_Items
{
    ...
    public function getViewUrl($order)
    {
        ...
        return Mage::getUrl('*/*/view', array('order_id' => $orderId));
    }
    ...
    public function getShipmentUrl($order)
    {
		$orderId= Mage::helper('core')->encrypt($order->getId());
		$orderId = base64_encode($orderId);
        return Mage::getUrl('*/*/shipment', array('order_id' => $orderId));
    }
    ...
    public function getCreditmemoUrl($order)
    {
		$orderId= Mage::helper('core')->encrypt($order->getId());
		$orderId = base64_encode($orderId);
        return Mage::getUrl('*/*/creditmemo', array('order_id' => $orderId));
    }
    ...
    public function getPrintAllInvoicesUrl($order){
		$orderId= Mage::helper('core')->encrypt($order->getId());
		$orderId = base64_encode($orderId);
        return Mage::getUrl('*/*/printInvoice', array('order_id' => $orderId));
    }
}
