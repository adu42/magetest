...
class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
{
    ...
    public function start($sessionName=null)
    {
		...
		if($this->isBot()){ if($cookie->getLifetime()>30)$cookie->setLifetime(30); } //by@ado
    ...
    protected function _validate()
    {
        ...
        if ($this->useValidateSessionExpire()
            ...
            // by@ado for cookie not expire,session expired. data exist.
            $this->_data[self::VALIDATOR_KEY][self::VALIDATOR_SESSION_EXPIRE_TIMESTAMP] = time()+60;
            // return false;
        } else {
