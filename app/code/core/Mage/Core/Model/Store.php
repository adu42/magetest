...
class Mage_Core_Model_Store extends Mage_Core_Model_Abstract
{
    ...
    public function formatPrice($price, $includeContainer = true)
    {
        if ($this->getCurrentCurrency()) {
            ...
            $price = $this->getCurrentCurrency()->format($price, $options, $includeContainer);
        }
        return $price;
    }
    ...
    /**
     * Retrieve BaseSkinVersion
     * By@ado
     * @return string
     */
    public function getBaseSkinVersion(){
        return $this->getConfig('web/unsecure/base_skin_version');
    }
    /**
     * By@ado
     * is int price 
     * @return boolen
     */
    public function needIntPrice(){
        try{
            $currentCurrencyCode=$this->getCurrentCurrency()->getCode();
        }catch(exception $e){$currentCurrencyCode='';}
        return (in_array($currentCurrencyCode,array('DKK','SEK','NOK','ZAR','RUB')));
    }
}
