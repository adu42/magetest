...
class Mage_Review_Model_Review extends Mage_Core_Model_Abstract
{
    ...
    //
    public function getTargetRatingValue($review_id)
    {
        return $this->_getTargetRatingValue($review_id);
    }

    //
    protected function _getTargetRatingValue($review_id)
    {
        $table_name = 'review_detail';
