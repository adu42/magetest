...
/**
    ...
    protected function _countratingrang($count)
    {
        ...
        $remainder_z = $remainder_z * 2 + $_rcount_y * 2 ; // 4*2=8 0.5*2=1   �ϼ�9 ��ɫ���ǵ�div����
        $_rcount_z = max(0,(10 - $remainder_z)) ; //ǳɫ���ǵ�div����
    ...
    protected function _countrating($rating,$cat_id,$store_id)
    {
        ...
        // ����ƽ���� �ȼ����ܷ֣��ڼ��ϵ�ǰ�֣��������ڵ�ƽ����
        $_defaultTotal = ( $_getRating * $_getCountTotal ) +  $rating ;  //��ǰ�ܷ�
        $_ratingNow = $_defaultTotal / ( $_getCountTotal + 1) ;  //��õ�ǰ����
