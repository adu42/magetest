...
//        }
        ...
        if ($result_count) {
                 $result = $this->_getWriteAdapter()
                    ->update(
                        ...
                        $this->_getWriteAdapter()->quoteInto('attribute_id=? AND ', $attribute_id)
                        .$this->_getWriteAdapter()->quoteInto('store_id=? AND ', $store_id)
                        .$this->_getWriteAdapter()->quoteInto('entity_id=? ', $cat_id)
                    ); 
                 ...
                 $result = $this->_getWriteAdapter()
                    ->update(
                        ...
                        $this->_getWriteAdapter()->quoteInto('attribute_id=? AND ', $attribute_id)
                        .$this->_getWriteAdapter()->quoteInto('store_id=? AND ', 0)
                        .$this->_getWriteAdapter()->quoteInto('entity_id=? ', $cat_id)
                    ); 
        }
    ...
    public function getAttributeId($attribute_code)
    {
        ...
        $attribute_id = $this->_getReadAdapter()->fetchOne($select);  
