...
{  
  ...
  public function clearcacheAction(){
    ...
    public function mousetrackingAction()
    {
			...
			$this->getLayout()->getBlock('head')->setCanLoadExtJs(true);
			$this->getLayout()->getBlock('head')->setTitle($this->__('Mousetracking'));
    ...
    public function mousetrackAction()
    {
      $this->_initAction();   			
    ...
    public function mousetrackIframeAction()
    {
      $this->_initAction();   			
      $block = $this->getLayout()->createBlock('magebird_popup/mousetracking')->setTemplate('magebird/popup/iframe.phtml');          
      $this->getResponse()->setBody($block->toHtml()); 
    }     
