<?php require_once(Mage::getBaseDir('lib') . '/magebird/popup/MaxMind/Db/Reader2.php');
...
class Magebird_Popup_Block_Adminhtml_Renderer_Country extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
        ...
        $geo = $geodb->get($row->getUserIp());
        return Mage::helper('magebird_popup')->__($geo['country']['names']['en']);
    }
} ?>