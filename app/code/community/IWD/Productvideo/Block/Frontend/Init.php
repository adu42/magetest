...
class IWD_Productvideo_Block_Frontend_Init extends Mage_Core_Block_Template
{
    ...
    const XML_PATH_VIDEO_AUTOPLAY = "iwd_productvideo/video/autoplay";  //自动播放
    const XML_PATH_VIDEO_RELATED = "iwd_productvideo/video/youtube_rel";  //相关视频
    ...
    {
        return Mage::getStoreConfig(self::XML_PATH_VIDEO_AUTOPLAY, Mage::app()->getStore());
    }
 
     public function getRelated()
    {
        return Mage::getStoreConfig(self::XML_PATH_VIDEO_RELATED, Mage::app()->getStore());
    }
    ...
    public function getVideosCollection($product_id = null)
    {
