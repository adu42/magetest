...
if (version_compare($version, '1.6.1.2', '>=')) {
    ...
    Mage::log("[Rural 1.15.4] Successfully added allowed blocks to Magento's white list. Required for compatibility with Magento 1.9.2.2 and later.",
        null, "Dock_Rural.log");
}
