...
$oldSearchPosition = Mage::getStoreConfig('rural/header/search_position');
...
{
	Mage::getConfig()->saveConfig('rural/header/search_position', $newSearchPosition);
}
if ($newSearchInUserMenuPosition !== NULL)
{
	Mage::getConfig()->saveConfig('rural/header/search_in_user_menu_position', $newSearchInUserMenuPosition);
}
if ($makeRightColumnWide)
{
	Mage::getConfig()->saveConfig('rural/header/left_column',		4);
	Mage::getConfig()->saveConfig('rural/header/central_column',	' ');
	Mage::getConfig()->saveConfig('rural/header/right_column',		8);
}
