...
class Dock_Rural_Block_Adminhtml_System_Config_Form_Field_Tex extends Mage_Adminhtml_Block_System_Config_Form_Field
{
	/**
	 * @deprecated
	 *
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		...
		$jsUrl = $this->getJsUrl('dock/jquery/jquery-1.7.2.min.js');
		//$texUrl = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) . Mage::helper('rural')->getTexPath();
