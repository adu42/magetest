...
class Dock_Rural_Helper_Template_Page_Html_Header extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_menuModuleName = 'Dock_UltraMegamenu';
    protected $_menuModuleNameShort = 'ultramegamenu';

    /**
     * Main helper of the theme
     *
     * @var Dock_Rural_Helper_Data
     */
    protected $theme;
