...
class Dock_Dataporter_Block_System_Config_Form_Field_Configimpex
	extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
	...
	{
		$imageDirectoryBaseUrl = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) . 'dock/system/css/images';
