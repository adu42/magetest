 ...
 */
class Dock_UltraMegamenu_Block_Category_Attribute_Helper_Dropdown_Blocks
	extends Mage_Adminhtml_Block_Catalog_Helper_Form_Wysiwyg
{
	...
	public function getElementHtml()
	{
		...
		//Scripts
		if (!Mage::registry('dock_admin_jquery'))
		{
			$jqueryUrl = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_JS) . 'dock/jquery/jquery-for-admin.min.js';
			$html .= '<script type="text/javascript" src="' . $jqueryUrl . '"></script>';
			$html .= '<script type="text/javascript">jQuery.noConflict();</script>';
			Mage::register('dock_admin_jquery', 1);
		}
		$html .= '
