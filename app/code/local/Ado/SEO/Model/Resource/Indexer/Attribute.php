 ...
 */
class Ado_SEO_Model_Resource_Indexer_Attribute extends Mage_Index_Model_Resource_Abstract
{
    ...
    {
        $this->_init('ado_seo/attribute_url_key', 'id');
    }

    /**
     * Reindex all
     *
     * @return Ado_SEO_Model_Resource_Indexer_Attribute
     */
    ...
    protected function _getInsertValues($attribute, $storeId)
    {
        ...
        foreach ($options as $option) {
            ...
            $data[] = array(
                'attribute_code' => str_replace(Ado_SEO_Model_System_Rewrite::MULTIPLE_FILTERS_SIBLING_DELIMITER,Ado_SEO_Model_System_Rewrite::FILTERS_WORDS_DELIMITER,$attribute->getAttributeCode()),
