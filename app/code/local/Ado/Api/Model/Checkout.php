...
class Ado_Api_Model_Checkout extends Ado_Api_Model_Abstract {
    ...
    public function getShippingMethodByQuote($quote){
        ...
        foreach($rates as $rate){
            if($rate->getCode() == $shippingMethod){
                ...
                $result_rates['price'] = number_format(Mage::getModel('mapi/currency')->getCurrencyPrice($rate->getPrice()),2,'.','');
    ...
    public function getShippingMethodListByQuote($quote){
        ...
        foreach($rates as $rate){
            ...
            $temp_rates['price'] =  number_format(Mage::getModel('mapi/currency')->getCurrencyPrice($rate->getPrice()),2,'.','');
