    ...
    */
    ...
    class EcommerceTeam_Ddc_Block_Form extends Mage_Checkout_Block_Onepage_Abstract{
        ...
        public function getDeliveryFeeLabel(){
            return Mage::getModel('ecommerceteam_ddc/config')->_getConfig('deliveryfee_label');
        }
        
        public function getDeliveryFeeOptions(){
            return Mage::getModel('ecommerceteam_ddc/config')->getDeliveryFeeOptions();
        }
        public function getDeliveryFeeId(){
            return $this->getCheckout()->getDeliveryFeeId();
        }
    }