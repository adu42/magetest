...
Object.extend(Object.extend(DressColor.prototype, ColorChart.prototype), {
    ...
    defaultColor: function(){
        var def = {};
        def['chiffon01'] = {name: 'Daffodil', dtImg: 'Chiffon/Daffodil', ddImg: 'Chiffon'};
        def['elastic_woven_satin01'] = {name: 'Daffodil', dtImg: 'Elastic-Woven-Satin/Daffodil', ddImg: 'Elastic-Woven-Satin'};
        def['matte_satin01'] = {name: 'Daffodil', dtImg: 'Matte-Satin/Daffodil', ddImg: 'Matte-Satin'};
        def['organza01'] = {name: 'Daffodil', dtImg: 'Organza/Daffodil', ddImg: 'Organza'};
        def['satin01'] = {name: 'Daffodil', dtImg: 'Satin/Daffodil', ddImg: 'Satin'};
        def['silk_like_satin01'] = {name: 'Daffodil', dtImg: 'Silk-Like-Satin/Daffodil', ddImg: 'Silk-Like-Satin'};
        def['taffeta01'] = {name: 'Daffodil', dtImg: 'Taffeta/Daffodil', ddImg: 'Taffeta'};
        return def;
    },
